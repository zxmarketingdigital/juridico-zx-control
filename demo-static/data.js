// Dados fictícios da DEMO estática do Jurídico (CD Tech). Porte de demo/data.mjs
// para um global de browser (window.__DEMO__). Nicho jurídico, pt-BR realista.
// Datas relativas a "agora" pra a agenda mostrar vencido/vencendo/futuro.
...
window.__DEMO__ = (function () {
  ...
  return { clientes, casos, documentos, prazos, advogados, advogado_clientes, pecas_geradas, leads, receitas, custos, pre_notas };
})();
