...
const ROTAS: Array<[string, string]> = [
  ...
  ["/api/advogados", "POST"],
  ["/api/datajud", "POST"],
  ["/api/clientes/abc/advogados", "GET"],
  ["/api/clientes/abc/advogados", "POST"],
  ["/api/clientes/abc/advogados/xyz", "DELETE"],
  ["/api/advogados/abc/acesso", "POST"],
  ["/api/leads", "GET"],
  ["/api/leads", "POST"],
  ["/api/receitas", "GET"],
  ["/api/custos", "GET"],
  ["/api/pre_notas", "GET"],
  ["/api/growth", "GET"],
  ["/api/leads/abc/converter", "POST"],
  ["/api/pre_notas/gerar", "POST"],
];
