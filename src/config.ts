...
// Chave PÚBLICA publicada pelo CNJ para a API pública (não é segredo). O Worker
// usa env.DATAJUD_API_KEY se definida; senão cai nesta. "Um valor, um lugar".
export const DATAJUD_API_KEY_PUBLICA =
  "cDZHYzlZa0JadVREZDJCendQbXY6SkJlTzNjLV9TRENyQk1RdnFKZGRQdw==";
export const DATAJUD_TIMEOUT_MS = 20_000;
