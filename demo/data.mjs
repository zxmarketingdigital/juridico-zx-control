...
export const advogados = [
  { id: "adv-1", nome: "Dra. Helena Marques", oab: "SP 123.456", email: "helena@escritorio.adv.br", created_at: ago(120) },
  { id: "adv-2", nome: "Dr. Rafael Andrade", oab: "SP 234.567", email: "rafael@escritorio.adv.br", created_at: ago(118) },
  { id: "adv-3", nome: "Dra. Beatriz Nunes", oab: "RJ 98.765", email: "beatriz@escritorio.adv.br", created_at: ago(110) },
  { id: "adv-4", nome: "Dr. Paulo Tavares", oab: "MG 45.321", email: "paulo@escritorio.adv.br", created_at: ago(96) },
  { id: "adv-5", nome: "Dra. Carolina Dias", oab: "SP 311.222", email: "carolina@escritorio.adv.br", created_at: ago(80) },
  { id: "adv-6", nome: "Dr. Marcos Vinícius", oab: "PR 67.890", email: "marcos@escritorio.adv.br", created_at: ago(70) },
  { id: "adv-7", nome: "Dra. Juliana Prado", oab: "SP 402.113", email: "juliana@escritorio.adv.br", created_at: ago(55) },
  { id: "adv-8", nome: "Dr. Eduardo Camargo", oab: "BA 33.198", email: "eduardo@escritorio.adv.br", created_at: ago(40) },
  { id: "adv-9", nome: "Dra. Patrícia Lopes", oab: "SC 21.456", email: "patricia@escritorio.adv.br", created_at: ago(28) },
  { id: "adv-10", nome: "Dr. Thiago Bastos", oab: "SP 455.789", email: "thiago@escritorio.adv.br", created_at: ago(15) },
];

// Vínculos advogado ⇄ cliente (N:N)
export const advogado_clientes = [
  { advogado_id: "adv-1", cliente_id: "cli-2" }, { advogado_id: "adv-1", cliente_id: "cli-1" },
  { advogado_id: "adv-2", cliente_id: "cli-1" }, { advogado_id: "adv-3", cliente_id: "cli-6" },
  { advogado_id: "adv-4", cliente_id: "cli-4" }, { advogado_id: "adv-5", cliente_id: "cli-3" },
  { advogado_id: "adv-7", cliente_id: "cli-9" }, { advogado_id: "adv-7", cliente_id: "cli-10" },
  { advogado_id: "adv-8", cliente_id: "cli-8" }, { advogado_id: "adv-10", cliente_id: "cli-5" },
];

// Movimentações (andamentos) — espelham o DataJud, por caso
export const movimentacoes = [
  { id: "mov-1", caso_id: "cas-1", data: ago(20), codigo: 26, descricao: "Distribuição por sorteio", fonte: "datajud" },
  { id: "mov-2", caso_id: "cas-1", data: ago(12), codigo: 51, descricao: "Audiência designada", fonte: "datajud" },
  { id: "mov-3", caso_id: "cas-1", data: ago(4), codigo: 85, descricao: "Decisão — defiro a juntada", fonte: "datajud" },
  { id: "mov-4", caso_id: "cas-2", data: ago(30), codigo: 26, descricao: "Distribuição por dependência", fonte: "datajud" },
  { id: "mov-5", caso_id: "cas-2", data: ago(9), codigo: 123, descricao: "Conclusos para despacho", fonte: "datajud" },
  { id: "mov-6", caso_id: "cas-4", data: ago(15), codigo: 246, descricao: "Sentença publicada", fonte: "datajud" },
  { id: "mov-7", caso_id: "cas-6", data: ago(7), codigo: 60, descricao: "Expedição de mandado", fonte: "datajud" },
  { id: "mov-8", caso_id: "cas-9", data: ago(2), codigo: 11010, descricao: "Petição protocolada", fonte: "datajud" },
];
...
// ── Growth / CRM ──────────────────────────────────────────────────────────
export const leads = [
  { id: "led-1", nome: "Marcelo Tavares (MEI)", contato: "(11) 98800-1122", origem: "Instagram Ads", status: "recebeu_formulario", cliente_id: null, created_at: ago(9) },
  { id: "led-2", nome: "Restaurante Sabor & Cia", contato: "contato@saborecia.com", origem: "Indicação", status: "respondeu_formulario", cliente_id: null, created_at: ago(8) },
  { id: "led-3", nome: "Lucas Pereira", contato: "(21) 99711-2233", origem: "Google Ads", status: "reuniao_agendada", cliente_id: null, created_at: ago(7) },
  { id: "led-4", nome: "Ana Beatriz (autônoma)", contato: "ana.bia@gmail.com", origem: "Instagram Ads", status: "desqualificado", cliente_id: null, created_at: ago(6) },
  { id: "led-5", nome: "Transportadora RotaSul", contato: "(41) 3322-1100", origem: "LinkedIn", status: "reuniao_agendada", cliente_id: null, created_at: ago(5) },
  { id: "led-6", nome: "Mariana Gomes", contato: "(31) 98444-7788", origem: "Indicação", status: "respondeu_formulario", cliente_id: null, created_at: ago(4) },
  { id: "led-7", nome: "Oficina do Zé", contato: "(85) 98123-9090", origem: "Google Ads", status: "recebeu_formulario", cliente_id: null, created_at: ago(3) },
  { id: "led-8", nome: "Construções Alfa", contato: "rh@alfaconstroi.com", origem: "Site", status: "convertido", cliente_id: "cli-1", created_at: ago(40) },
  { id: "led-9", nome: "Patrícia Ramos", contato: "(11) 97000-4545", origem: "Instagram Ads", status: "reuniao_agendada", cliente_id: null, created_at: ago(2) },
  { id: "led-10", nome: "Studio Bem-Estar", contato: "studio@bemestar.com", origem: "Indicação", status: "desqualificado", cliente_id: null, created_at: ago(1) },
];

export const receitas = [
  { id: "rec-1", cliente_id: "cli-1", descricao: "Assessoria mensal", valor: 2500, tipo: "recorrente", data: ago(30) },
  { id: "rec-2", cliente_id: "cli-3", descricao: "Contrato mensal", valor: 1800, tipo: "recorrente", data: ago(30) },
  { id: "rec-3", cliente_id: "cli-9", descricao: "Assessoria mensal", valor: 1500, tipo: "recorrente", data: ago(28) },
  { id: "rec-4", cliente_id: "cli-2", descricao: "Honorários — ação trabalhista", valor: 6000, tipo: "unica", data: ago(20) },
  { id: "rec-5", cliente_id: "cli-7", descricao: "Plano mensal", valor: 2200, tipo: "recorrente", data: ago(15) },
  { id: "rec-6", cliente_id: "cli-5", descricao: "Êxito — acordo", valor: 4500, tipo: "unica", data: ago(12) },
  { id: "rec-7", cliente_id: "cli-11", descricao: "Assessoria mensal", valor: 1200, tipo: "recorrente", data: ago(10) },
  { id: "rec-8", cliente_id: "cli-4", descricao: "Consultoria avulsa", valor: 900, tipo: "unica", data: ago(8) },
  { id: "rec-9", cliente_id: "cli-6", descricao: "Plano mensal", valor: 1600, tipo: "recorrente", data: ago(5) },
  { id: "rec-10", cliente_id: "cli-8", descricao: "Honorários — cível", valor: 3000, tipo: "unica", data: ago(3) },
];

export const custos = [
  { id: "cst-1", descricao: "Aluguel do escritório", valor: 3200, tipo: "fixo_mensal", data: ago(30) },
  { id: "cst-2", descricao: "Salários e pró-labore", valor: 9800, tipo: "fixo_mensal", data: ago(30) },
  { id: "cst-3", descricao: "Software jurídico + nuvem", valor: 650, tipo: "fixo_mensal", data: ago(30) },
  { id: "cst-4", descricao: "Meta Ads (Instagram)", valor: 1800, tipo: "anuncios", data: ago(25) },
  { id: "cst-5", descricao: "Google Ads", valor: 1500, tipo: "anuncios", data: ago(20) },
  { id: "cst-6", descricao: "Reforma da sala de reunião", valor: 4200, tipo: "unico", data: ago(60) },
  { id: "cst-7", descricao: "Notebook novo", valor: 5200, tipo: "unico", data: ago(45) },
  { id: "cst-8", descricao: "Contador", valor: 700, tipo: "fixo_mensal", data: ago(30) },
  { id: "cst-9", descricao: "LinkedIn Ads", valor: 600, tipo: "anuncios", data: ago(10) },
  { id: "cst-10", descricao: "Internet e telefonia", valor: 380, tipo: "fixo_mensal", data: ago(30) },
];

export const pre_notas = [
  { id: "pn-1", cliente_id: "cli-1", numero: "PN-2026-001", descricao_servico: "Assessoria jurídica mensal", valor: 2500, vencimento: ahead(10), conteudo: "# PRÉ-NOTA PN-2026-001\n\n**Cliente:** Construtora Horizonte Ltda.\n**Serviço:** Assessoria jurídica mensal\n**Valor:** R$ 2.500,00\n\n---\n_Documento auxiliar de cobrança — **não é nota fiscal**._", created_at: ago(5) },
  { id: "pn-2", cliente_id: "cli-2", numero: "PN-2026-002", descricao_servico: "Honorários — ação trabalhista", valor: 6000, vencimento: ahead(15), conteudo: "# PRÉ-NOTA PN-2026-002\n\n**Cliente:** Maria Aparecida de Souza\n**Serviço:** Honorários — ação trabalhista\n**Valor:** R$ 6.000,00\n\n---\n_Documento auxiliar de cobrança — **não é nota fiscal**._", created_at: ago(3) },
];
